...
export const FetchFacilitiesData = [
...

  {
    ...
    "long_description": "The institute is equipped with an advanced unit with Histopathology, Cytology services along with routine Pathology, Biochemistry etc\n\nEquipped with the state of art Biomerieux  Vidas system, Fuji drichem series and siemens wet chemistry analyzer, we strive to adhere to the Good Laboratory Practices to provide accurate and reliable laboratory results to our patients.",
    "read_more2": false,
    "read_more": true,
