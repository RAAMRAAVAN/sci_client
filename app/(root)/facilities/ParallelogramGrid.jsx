...
const images = [
  '/Dibrugarh/Facilities/2.jpg',
  '/Dibrugarh/Facilities/11.jpg',
  '/Dibrugarh/Facilities/6.jpg',
  '/Dibrugarh/Facilities/3.jpg',
  '/Dibrugarh/Facilities/14.jpg',
];
          ...
          >
            ...
            >
              <Box display='flex' width='200%' height='100%' position='absolute'>
                <img src={images[index + 1]} style={{ display: 'flex', height: 'auto', width:'100%' }} />
